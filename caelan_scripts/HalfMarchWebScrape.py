...
'''Otherwise use this'''
# driver = webdriver.Chrome(executable_path="C:/Users/hepne/Downloads/chromedriver_win32 (1)/chromedriver.exe")
...
try:
    for j in range(2, 3):
        for k in range(20,month_lengths[j]+1):
            total_array = []
            driver.get(f'https://www.wunderground.com/history/daily/us/ca/burbank/KBUR/date/2018-{j+1}-{k}')
            time.sleep(1)
